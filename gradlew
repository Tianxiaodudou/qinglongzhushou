...
#       temporary focusing, current ones.
#
...
#   * Put system overrides second.
#   * Put Gradle-specific overrides last.

# Use "set --" to process remaining arguments.
set -- \
...
# Determine if we are in "batch" mode and set "xargs" accordingly.
case "$( uname )" in
    MINGW* | MSYS* )  xargs=" -0" ;;
    *)                xargs="" ;;
esac

# Use "xargs" to parse quoted args, if available.
